...
/** Called before a new opponent link is accepted. */
public final class CombatPreStartEvent extends Event implements Cancellable {
    ...
    public CombatPreStartEvent(Player attacker, Player target, TagCause cause,
